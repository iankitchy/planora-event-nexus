        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Create, discover, and manage events with a beautiful, intuitive platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/browse" className="text-muted-foreground hover:text-foreground">Browse Events</Link></li>
